...
- Create Angular project with ng: `ng new countdown-prototype.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`countdown-prototype.client.esproj`).
